...
printf("Informe a primeira nota do aluno 1: \n");
scanf("%f", &n1a1);

printf("Informe a segunda nota do aluno 1: \n");
scanf("%f", &n2a1);

printf("Informe a terceira nota do aluno 1: \n");
scanf("%f", &n3a1);

m1=(n1a1+n2a1+n3a1)/3;
mm1=(n1a1 + n2a1*2 + n3a1*3 + m1)/7;

printf("A média das notas do aluno 1 é: %.2f\n", m1);
printf("\n");
...
printf("Informe a primeira nota do aluno 2: \n");
scanf("%f", &n1a2);

printf("Informe a segunda nota do aluno 2: \n");
scanf("%f", &n2a2);

printf("Informe a terceira nota do aluno 2: \n");
scanf("%f", &n3a2);

m2=(n1a2+n2a2+n3a2)/3;
mm2=(n1a2 + n2a2*2 + n3a2*3 + m2)/7;

printf("A média das notas do aluno 2: %.2f\n", m2);
printf("\n");
...
printf("Informe a primeira nota do aluno 3: \n");
scanf("%f", &n1a3);

printf("Informe a segunda nota do aluno 3: \n");
scanf("%f", &n2a3);

printf("Informe a terceira nota do aluno 3: \n");
scanf("%f", &n3a3);

m3=(n1a3+n2a3+n3a3)/3;
mm3=(n1a3 + n2a3*2 + n3a3*3 + m3)/7;

printf("A média das notas do aluno 3 é: %.2f\n", m3);
printf("\n");
